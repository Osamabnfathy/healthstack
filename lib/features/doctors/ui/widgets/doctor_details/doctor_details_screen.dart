                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      buildInfoRow('Visiting Hours',
                          getDisplayText(doctorsData?.visitingHour)),
                      buildInfoRow('Checkup Fee',
                          "${getDisplayText(doctorsData?.consultationFee.toString())} EGP"),
                      buildInfoRow('Report Fee',
                          "${getDisplayText(doctorsData?.reportFee.toString())} EGP"),
                    ],
                  ),
                ),

                // Book Appointment Button - now at bottom of scrollable content
                Padding(
                  padding: EdgeInsets.all(15.w),
                  child: AppTextButton(
                    onPressed: () {
                      Navigator.pushNamed(
                          context, Routes.firstAppointmentScreen,
                          arguments: {
